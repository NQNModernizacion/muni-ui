...
import { FullscreenLoader } from "../src/components/Spinner";
...
function App() {
  ...
  const rows: Row[] = [
    { h2: "H2", name: "prioridad_ticket", label: "Ninguna" },
    { h2: "H2", name: "prioridad_ticket", label: "Baja" },
    { h2: "H2", name: "prioridad_ticket", label: "Media" },
    { h2: "H2", name: "prioridad_ticket", label: "Alta" },
    { h2: "H2", name: "prioridad_ticket", label: "Muy Alta" },
  ];
  ...
  return (
    <div className="min-h-screen bg-bg p-6 flex items-center justify-center">
      ...
      <div className="w-full max-w-2xl space-y-4">
        ...
        <div className="bg-bg p-6 space-y-4 rounded-xl border border-border">
          <MuniSpinner text="Procesando..." />

          <ButtonBase type="button" onClick={() => setLoading(true)}>
            Mostrar loader
          </ButtonBase>
        ...
        <Card title="Formulario" bgColor="gray">
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="space-y-6 p-4">
              ...
              <RHFTextarea
                ...
                rows={5}
                smallText="Máximo 500 caracteres."
              />
            ...
            <div className="border-t border-border bg-surface px-6 py-4 flex items-center justify-end gap-3">
